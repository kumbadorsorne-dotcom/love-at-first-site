    ...
    <div style={{ minHeight:'100vh', background:'var(--ink)', color:'var(--cream)', position:'relative', overflow:'hidden' }}>
      ...
      <header style={{ padding:'14px 36px', display:'flex', justifyContent:'space-between', alignItems:'center', borderBottom:'1px solid #FFFFFF18' }}>
        ...
        <div style={{ display:'flex', gap: 10, alignItems:'center' }}>
          ...
          <div style={{ display:'flex', gap: 6 }}>
            ...
            <div style={{ width: 22, height: 4, borderRadius: 2, background:'#FF3333', opacity: 0.4 }}/>
          </div>
        ...
        <div style={{ display:'flex', flexDirection:'column', gap: 12, minHeight: 0 }}>
          <div style={{ border:'1px solid #FFFFFF20', borderRadius: 2, padding:'12px 14px', background:'#0A0A0A', color:'#FFFFFF', display:'flex', flexDirection:'column', minHeight: 0 }}>
            <div style={{ display:'flex', justifyContent:'space-between', alignItems:'baseline' }}>
              ...
              <div className="mono caps" style={{ fontSize: 8, color:'#FFFFFF', letterSpacing:'0.16em' }}>1 of 7</div>
            </div>
          ...
          <div style={{ border:'1px solid #FFFFFF20', borderRadius: 2, padding:'10px 12px', background:'#111111' }}>
            <div className="mono caps" style={{ fontSize: 8, color:'#FFFFFFB0', letterSpacing:'0.14em', marginBottom: 8 }}>Up next {'\u00b7'} calls 2-7</div>
      ...
      {showDropout && (
        <div style={{
          ...
          background:'#1A1A1A', border:'2px solid #800120', borderRadius: 16,
          ...
          <div style={{ padding:'20px 22px' }}>
            ...
            <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center' }}>
              <div style={{ display:'flex', gap: 10, alignItems:'center' }}>
                ...
                <div>
                  <div className="serif" style={{ fontSize: 17, lineHeight: 1.1, color:'#FFFFFF' }}>
            ...
            <div style={{ marginTop: 16, padding:'12px 14px', background:'#0A0A0A', borderRadius: 10, display:'flex', alignItems:'center', gap: 12 }}>
              <div style={{ width: 40, height: 40, borderRadius: 10, overflow:'hidden', border:'2px solid #FF333330', position:'relative', flexShrink: 0 }}>
                <div style={{ position:'absolute', inset: -4, filter:'blur(6px) grayscale(1) opacity(0.5)' }}>
                  <Silhouette seed={droppedPerson.seed}/>
                </div>
              </div>
              <div style={{ flex: 1 }}>
                <div className="serif" style={{ fontSize: 16, color:'#FFFFFF', lineHeight: 1 }}>
                  {droppedPerson.name}<span style={{ color:'#FFFFFF50', fontStyle:'italic', fontSize: 13 }}>, {droppedPerson.age}</span>
                </div>
                <div className="mono" style={{ fontSize: 9, color:'#FF4444', marginTop: 3 }}>Left the pod</div>
              </div>
            ...
            <div style={{ marginTop: 16 }}>
              ...
              <div className="mono" style={{ display:'flex', justifyContent:'space-between', fontSize: 8, color:'#FFFFFF', letterSpacing:'0.06em', marginTop: 6 }}>
            ...
            {/* Info text */}
            <div style={{ marginTop: 14, padding:'10px 12px', background:'#FFFFFF06', borderRadius: 8, border:'1px solid #FFFFFF0A' }}>
              <div className="mono" style={{ fontSize: 10, color:'#FFFFFF', lineHeight: 1.5 }}>
                Your pod now has <span style={{ fontWeight: 700 }}>8 people</span> and <span style={{ fontWeight: 700 }}>7 calls.</span>
              </div>
              <div className="mono" style={{ fontSize: 9, color:'#FFFFFFB0', marginTop: 2, lineHeight: 1.4 }}>
                Your call order has been adjusted automatically.
              </div>
            </div>
            ...
            <button onClick={dismissDropout} style={{
              ...
              fontFamily:'Lato, sans-serif', fontSize: 10, letterSpacing:'0.12em', textTransform:'uppercase',
              borderRadius: 10, border:'none', cursor:'pointer', fontWeight: 700,
              transition:'all .15s ease'
            }}
            onMouseEnter={e => { e.target.style.background = '#FFFFFFDD'; }}
